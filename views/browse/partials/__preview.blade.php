            ...
            <div class="col-md-7 order-1 order-md-0">
                ...
                <div class="product bg-white p-3 rounded-2">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="w-75">
                            <p>{{ optional(optional($record->category)->category)->name }}
                                - {{ optional($record->category)->name }}</p>
                        </div>
                    </div>
                    <div class="d-flex justify-content-between">
                        <div class="w-25">
                            <p class="text-muted">{{ __('price') }}</p>
                        </div>
                        <div class="w-75">
                            <h6 class="text-primary fw-bolder">{{ $record->price }} {{ $record->currency->name ?? '' }}
                            </h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="badge bg-white w-100 mb-3 p-3" style="text-align: start!important;">
                    ...
                    <a href="{{ route(config('chatify.routes.prefix')) . '/' . $record->user->id . '/' . $record->id }}"
                        class="text-white btn btn-warning d-block w-100">
