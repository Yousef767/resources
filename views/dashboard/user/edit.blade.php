        ...
        <div class="col-12">
            <div class="card card-outline card-warning">
                <div class="card-header">
                    <h3 class="card-title">{{__('edit')}} {{__('user')}}</h3>
                </div>
                ...
                <form action="{{route('users.update', $record->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    <label for="password_confirmation">{{__('password_confirmation')}} <span class="text-danger">*</span></label>
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" value="{{$record->balance}}" placeholder="{{__('balance')}}" id="balance" class="form-control @error('balance') is-invalid @enderror" name="balance">
                                    @error('balance')
                                    <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select id="currency" class="form-control @error('currency_id') is-invalid @enderror"
                                        ...
                                        @foreach($currencies as $c)
                                            <option @if($c->id == $record->currency_id) selected
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="checkbox" name="admin" id="admin" value="1" {{ $record->admin ? 'checked' : '' }}>
                                </div>
                            </div>
                        </div>
                    </div>
