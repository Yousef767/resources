...
@section('title', ' - '.__('edit') .' '. __('slides'))
        ...
        <div class="col-12">
            <div class="card card-outline card-warning">
                <div class="card-header">
                    <h3 class="card-title">{{__('edit')}} {{__('slides')}}</h3>
                </div>

                <form action="{{route('slides.update', $record->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="card-body">
                        <div class="row">
