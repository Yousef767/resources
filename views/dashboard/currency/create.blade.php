...
@section('title', ' - '.__('create') .' '. __('currency'))
        ...
        <div class="col-12">
            <div class="card card-outline card-warning">
                <div class="card-header">
                    <h3 class="card-title">{{__('create')}} {{__('currency')}}</h3>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input placeholder="{{__('rate')}}" id="rate" value="{{old("rate")}}" type="number" step="0.01" class="form-control @error('rate') is-invalid @enderror" name="rate">
                                    @error('rate')
                                    <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                    @enderror
                                </div>
